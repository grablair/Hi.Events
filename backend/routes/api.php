...
use HiEvents\Http\Actions\Users\CreateApiKeyAction;
...
use HiEvents\Http\Actions\Users\GetApiKeysAction;
...
use HiEvents\Http\Actions\Users\RevokeApiKeyAction;
...
/**
 * Routes accessible by users and API keys
 */
$router->middleware(['auth:sanctum'])->group(
    function (Router $router): void {
        ...
        $router->middleware(['ability:events'])->group(
            function (Router $router): void {
